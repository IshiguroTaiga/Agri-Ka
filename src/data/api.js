...
// AUTH API
export const loginApi = (username, password) => apiFetch('/auth/login', { method: 'POST', body: JSON.stringify({ username, password }) });
...
export const toggleHideKnowledgeItem = (id, isHidden) => apiFetch(`/knowledge/${id}/hide`, { method: 'PUT', body: JSON.stringify({ isHidden }) });
...
export const toggleHideInventoryItem = (id, isHidden) => apiFetch(`/inventory/${id}/hide`, { method: 'PUT', body: JSON.stringify({ isHidden }) });
...
export const toggleHideAuditLog = (id, isHidden) => apiFetch(`/logs/${id}/hide`, { method: 'PUT', body: JSON.stringify({ isHidden }) });
...
export const toggleHideFinancial = (id, isHidden) => apiFetch(`/financials/${id}/hide`, { method: 'PUT', body: JSON.stringify({ isHidden }) });
...
export const toggleHideMonitoringEntry = (id, isHidden) => apiFetch(`/monitoring/${id}/hide`, { method: 'PUT', body: JSON.stringify({ isHidden }) });
